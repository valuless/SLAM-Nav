...
// // 手动指定字段映射，绕过 PCL 的类型检查
//   pcl::MsgFieldMap field_map;
//   field_map[0].name = "x";         field_map[0].offset = 0;  field_map[0].datatype = 7; field_map[0].count = 1;
//   field_map[1].name = "y";         field_map[1].offset = 4;  field_map[1].datatype = 7; field_map[1].count = 1;
//   field_map[2].name = "z";         field_map[2].offset = 8;  field_map[2].datatype = 7; field_map[2].count = 1;
//   field_map[3].name = "intensity"; field_map[3].offset = 12; field_map[3].datatype = 7; field_map[3].count = 1;
//   field_map[4].name = "ring";      field_map[4].offset = 16; field_map[4].datatype = 4; field_map[4].count = 1;
//   field_map[5].name = "time";      field_map[5].offset = 18; field_map[5].datatype = 8; field_map[5].count = 1;
//    pcl::fromROSMsg(*msg, pl_orig, field_map);
